...
var Alignment, ColumnAlignment, ColumnMargin, ColumnWidth, ColumnWidthCommon, ColumnX, axisTranstionTime, barWidth, barWidthMargin, circleRadius, margin, max_keyword_amount, svgHeight, svgWidth, totalHeight, totalWidth, yearTicksPadding;
...
ColumnWidth = {
  pol: ColumnWidthCommon * 0.7,
  his: ColumnWidthCommon * 1.6,
  food: ColumnWidthCommon * 0.7
};
