...
var axisCanvas, clearAllViews, drawBarChart, drawColLine, drawDocView, drawKeywordsAmount, drawMediaView, drawOverlapKeywords, drawTotalKeywords, drawYearLines, mouseClickOnBar, overlayCanvas, svg, switchToDocView, switchToMediaView, switchToPieView, switchToSubView;
...
drawBarChart = function(group, array, className, align, maxWidth) {
  ...
  return console.log(array.map(function(d) {
